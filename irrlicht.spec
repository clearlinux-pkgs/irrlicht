...
Version  : 1.8.5
Release  : 18
URL      : https://sourceforge.net/projects/irrlicht/files/Irrlicht%20SDK/1.8/1.8.5/irrlicht-1.8.5.zip
Source0  : https://sourceforge.net/projects/irrlicht/files/Irrlicht%20SDK/1.8/1.8.5/irrlicht-1.8.5.zip
...
Patch1: 0001-Makefile-system-zlib-and-libpng.patch
Patch2: 0002-Use-system-libjpeg-from-libjpeg-turbo-package.patch
...
%prep
%setup -q -n irrlicht-1.8.5
cd %{_builddir}/irrlicht-1.8.5
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643755899
...
cp %{_builddir}/irrlicht-1.8.5/doc/bzip2-license.txt %{buildroot}/usr/share/package-licenses/irrlicht/d964dbe91cbf7511e4f1857db9e99fdaf6658055
cp %{_builddir}/irrlicht-1.8.5/doc/irrlicht-license.txt %{buildroot}/usr/share/package-licenses/irrlicht/bcbd5fcde0d5d5a7a0e6729f024dec58d6f48777
cp %{_builddir}/irrlicht-1.8.5/doc/jpglib-license.txt %{buildroot}/usr/share/package-licenses/irrlicht/042c2d15bbb2ea50e91497a2efdecb91fb420fad
cp %{_builddir}/irrlicht-1.8.5/doc/libpng-license.txt %{buildroot}/usr/share/package-licenses/irrlicht/97b8284aa8384d431f7fb5d3f282cc5c40840a4f
cp %{_builddir}/irrlicht-1.8.5/source/Irrlicht/bzip2/LICENSE %{buildroot}/usr/share/package-licenses/irrlicht/1c0c6888759a63c32bca7eb63353af2cd9bd5d9e
cp %{_builddir}/irrlicht-1.8.5/source/Irrlicht/libpng/LICENSE %{buildroot}/usr/share/package-licenses/irrlicht/ddad81444c937f22e749ab9518058682953b1cdb
pushd source/Irrlicht
%make_install INSTALL_DIR=%{buildroot}/usr/lib64
popd
...
/usr/share/package-licenses/irrlicht/ddad81444c937f22e749ab9518058682953b1cdb
